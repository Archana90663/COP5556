...
public class CompilerComponentFactory implements IPLPLexer{
	
	ArrayList<Integer> startLineArray;
	String globalInput;
	int numberOfTokens;
	ArrayList<Token> tokensList;
	
//	public CompilerComponentFactory(String input) {
...
//	}
	...
	public IPLPToken nextToken() throws LexicalException {
		...
		if(numberOfTokens < tokensList.size()) {
			Token t = tokensList.get(numberOfTokens);
			t.setKind();
			numberOfTokens++;
			return t;
		}
...
public class Token implements IPLPToken{
	...
	public String getText() {
		 ...
		 */
		// TODO Auto-generated method stub
		String s = globalInput.substring(currentPosition, currentPosition + tokenLength);
		if(s != null)
			return s;
		return null;
	}
